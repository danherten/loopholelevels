...
.pg{padding:13px}
.bnav{position:fixed;top:auto;left:12px;right:12px;bottom:max(12px,var(--sb));background:linear-gradient(to bottom,rgba(48,48,74,.26),rgba(18,18,34,.34));backdrop-filter:blur(34px) saturate(210%);-webkit-backdrop-filter:blur(34px) saturate(210%);border:1px solid rgba(255,255,255,.16);border-radius:30px;box-shadow:inset 0 1px 0 rgba(255,255,255,.2),inset 0 -1px 1px rgba(0,0,0,.18),0 10px 34px rgba(0,0,0,.4);display:flex;align-items:center;padding:6px;z-index:50;will-change:auto;touch-action:none;user-select:none;-webkit-user-select:none;-webkit-tap-highlight-color:transparent;}
