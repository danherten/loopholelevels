        ...
        <div style={{display:'flex',flexDirection:'column',gap:9}}>
          {products.map(prod=>(
            <div key={prod.id} style={{background:'var(--card)',border:'1px solid var(--bo)',borderRadius:'var(--r)',overflow:'hidden'}}>
              {prod.image_url&&<div style={{width:'100%',overflow:'hidden',borderRadius:'var(--r) var(--r) 0 0'}}><img src={prod.image_url} alt={prod.name} style={{width:'100%',height:'auto',display:'block'}}/></div>}
